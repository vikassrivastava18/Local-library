...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-rb8qs)#by5za&(_4t9ms&__!2x%xq#lo18sb!r8rpvdcw=7^z+')
...
ALLOWED_HOSTS = ['127.0.0.1',
                 '13.201.20.174',
                 'ec2-13-201-20-174.ap-south-1.compute.amazonaws.com']
...
AUTH_PASSWORD_VALIDATORS = [
    {
        ...
        'OPTIONS': {
            ...
            # max_similarity defaults to 0.7
        }
    },
    {
        'NAME': 'django.contrib.auth.password_validation.MinimumLengthValidator',
        'OPTIONS': {
            'min_length': 8, # Default is 8 characters
        }
    },
    {
